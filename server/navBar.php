<!-- Developed by Se wing Huang and Aya Azzam  -->
    ...
    <nav class="navigation">
        <div class="log-btn">
            ...
            if (isset($_SESSION['UserID'])){
                ...
                echo '<a class-"buttonLoginPopUp" href="authentication/logout_process.php">Logout</a>';
            } else {
                echo '<a class-"buttonLoginPopUp" href="index.php">Market</a>';
                echo '<a class="buttonLoginPopUp" href="log.php">Login</a>';
                echo '<a class="buttonLoginPopUp" href="../pages/sign.html"> SignUp</a>';
            }
            ?>
            </div>
    </nav>
    ...
    <div class="menu">
        ...
        <?php
            if (isset($_SESSION['UserID'])){
                ...
                echo '<li><a class="buttonLoginPopUp" href="authentication/logout_process.php">Logout</a></li>';
            } else {
                echo '<li><a class="buttonLoginPopUp" href="index.php">Market</a></li>';
                echo '<li><a class="buttonLoginPopUp" href="log.php">Login</a></li>';
                echo '<li><a class="buttonLoginPopUp" href="../pages/sign.html"> SignUp</a></li>';
            }
            ?>
        </ul>
    </div>
